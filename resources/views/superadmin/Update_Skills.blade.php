                ...
                {{-- <form class="form-group" method="POST" action="/Save" enctype="multipart/form-data">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-12 col-xxl-12">
                            ...
                            <form class="form-group" method="POST" action="{{ route('update_data',$skill->id) }}" enctype="multipart/form-data">
                                @csrf
                        ...
                        <div class="row gx-0 kanban-header rounded-2 px-card py-2 mt-2 mb-3">
                            ...
                            <div class="col-auto d-flex align-items-center">
                                <button type="submit" name="submit"
                                    class="btn btn-sm btn-falcon-default me-2 d-none d-md-block"><span
                                        class="fas fa-plus me-1"></span>Update Skill</button>
                            </div>
                        </div>
                        <div class="row g-3 mb-3">
                            <div class="col-md-12 col-xxl-12">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group has-validation">
                                            <input class="form-control" placeholder="eg:Key Skills" value="{{$skill->title}}" name="title"
                                                type="text" id="title">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" " placeholder="Instructions"  name="benefits" cols="50" rows="10"
                                            id="benefits">{{$skill->benefits}}</textarea>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" placeholder="Instructions" name="description" cols="50" rows="10"
                                            id="description" >{{$skill->description}}</textarea>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
