...
<body>
    ...
    <main class="main" id="top">
                ...
                <div class="collapse navbar-collapse scrollbar" id="navbarStandard">
                    <ul class="navbar-nav" data-top-nav-dropdowns="data-top-nav-dropdowns">
                        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" role="button"
                                ...
                                id="dashboards" style="font-size:bold">Skills</a>
                            <div class="dropdown-menu dropdown-menu-card border-0 mt-0" aria-labelledby="dashboards">
                                <div class="bg-white dark__bg-1000 rounded-3 py-2"><a
                                        class="dropdown-item link-600 fw-medium" href="../index.html">Hard Skills</a><a
                                        class="dropdown-item link-600 fw-medium"
                                        href="../dashboard/analytics.html">Soft SkillsS</a>\
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" role="button"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                            id="dashboards" style="font-size:bold">Courses</a>
                        <div class="dropdown-menu dropdown-menu-card border-0 mt-0" aria-labelledby="dashboards">
                            <div class="bg-white dark__bg-1000 rounded-3 py-2"><a
                                    class="dropdown-item link-600 fw-medium" href="../index.html">Free Courses</a>
                                    <a
                                        class="dropdown-item link-600 fw-medium"
                                        href="../documentation/customization/dark-mode.html">Primum Courses<span
                                            class="badge rounded-pill ms-2 badge-soft-success">New</span></a>

                                            {{-- <a
                                    class="dropdown-item link-600 fw-medium"
                                    href="../dashboard/analytics.html"></a> --}}
                            </div>
                        </div>
                    </li>
                        ...
                        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#"
                                ...
                                id="documentations">About Us</a>
                            <div class="dropdown-menu dropdown-menu-card border-0 mt-0"
                                aria-labelledby="documentations">
                                <div class="bg-white dark__bg-1000 rounded-3 py-2"><a
                                        class="dropdown-item link-600 fw-medium"
                                        href="../documentation/getting-started.html">Our Team</a><a
                                        class="dropdown-item link-600 fw-medium"
                                        href="../documentation/customization/configuration.html">Company</a><a
                                        class="dropdown-item link-600 fw-medium"
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li>
                            <a href="{{ url('User_Register') }}" style="color:aliceblue">Register</a>
                    ...
                    <li class="form-inline my-2" style="text-decoration: none">
                        <a href="{{ url('User_Login') }}" style="color:aliceblue;">Login</a>
        ...
        <div id="hero" class="hero"
            style="background-image: url('{{ asset('images/cover-1.jpg') }}');background-repeat:no-repeat">
            ...
            <div class="container position-relative">
                <div class="row gy-5" data-aos="fade-in" >
                    ...
                    <div class="col-lg-6 order-1 order-lg-2">
                        <img src="{{ asset('images/undraw_graduation_re_gthn.svg') }}" class="img-fluid"
                    ...
                    <div class="row gy-4 mt-5" >
                        ...
                        <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
                            <div class="icon-box " style="background-color: #fff">
                                <div class="icon"><i class="bi bi-easel" style="color: black"></i></div>
                                <h4 class="title"><a href="" class="stretched-link" style="font-size: 19px; color:black">Fresh Graduates looking
                                        for a
        ...
        <main id="main">
            ...
            <section id="about" class="about">
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="section-header">
                        <h2>About Us</h2>
                        <p>Start, change, or advance your career with more than 12,000 courses, Professional
                            Certificates,
                    ...
                    <div class="row gy-4">
                        <div class="col-lg-6">
                            ...
                            <img src="{{ asset('images/about.jpg') }}" class="img-fluid rounded-4 mb-4"
                                alt="">
            ...
            <section id="call-to-action" class="call-to-action">
                <div class="container text-center" data-aos="zoom-out"  style="background-image: url('{{ asset('images/cover-1.jpg') }}');background-repeat:no-repeat"">
                    <a href="https://youtu.be/Ui7MZxhVj7w" class="glightbox play-btn"></a>
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <article>
                                ...
                                <h2 class="title">
                                    <a href="{{ url('/blog_details') }}">Possimus soluta ut id suscipit ea ut in quo
                                        quia
                                        et
                                        soluta</a>
                                </h2>
                                ...
                                <div class="clients-slider swiper">
                                    <div class="swiper-wrapper align-items-center">
                                        <div class="swiper-slide"><img
                                                src="{{ asset('images/clients/client-1.png') }}" class="img-fluid"
                                                alt=""></div>
                                        <div class="swiper-slide"><img
                                                src="{{ asset('images/clients/client-2.png') }}" class="img-fluid"
                                                alt=""></div>
                                        <div class="swiper-slide"><img
                                                src="{{ asset('images/clients/client-3.png') }}" class="img-fluid"
                                                alt=""></div>
                                        <div class="swiper-slide"><img
                                                src="{{ asset('images/clients/client-4.png') }}" class="img-fluid"
                                                alt=""></div>
                                        <div class="swiper-slide"><img
                                                src="{{ asset('images/clients/client-5.png') }}" class="img-fluid"
                                                alt=""></div>
                                        <div class="swiper-slide"><img
                                                src="{{ asset('images/clients/client-6.png') }}" class="img-fluid"
                                                alt=""></div>
                                        <div class="swiper-slide"><img
                                                src="{{ asset('images/clients/client-7.png') }}" class="img-fluid"
                                                alt=""></div>
                                        <div class="swiper-slide"><img
                                                src="{{ asset('images/clients/client-8.png') }}" class="img-fluid"
                                                alt=""></div>
                                    </div>
                                </div>
                                        ...
                                        <section id="stats-counter" class="stats-counter">
                                            <div class="container" data-aos="fade-up">
                                                ...
                                                <div class="row gy-4 align-items-center">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <img src="{{ asset('images/stats-img.svg') }}"
                                                            alt="" class="img-fluid">
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="stats-item d-flex align-items-center">
                                                            ...
                                                            <p><strong>Happy Clients</strong> consequuntur quae diredo
                                                                para mesta</p>
                                                        </div><!-- End Stats Item -->
                ...
                <div class="row gy-4">
                    <div class="col-lg-5 col-md-12 footer-info">
                        <a href="index.html" class="logo d-flex align-items-center">
                            <h2><a href="{{ url('/') }}" style="background-color: #fff">interviewo</a> </h2>
                        </a>
