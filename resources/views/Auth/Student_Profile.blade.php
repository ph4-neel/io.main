                    ...
                    <div class="col-lg-8 pe-lg-2">
                        <div class="card mb-3">
                            ...
                            <div class="card-body bg-light">
                                {{-- ==================neel --}}
                                <form class="row g-3" method="POST" action="/Student_Profile">
                                    @csrf
                                    <div class="col-lg-6">
                                        <label class="form-label" for="first-name">Full Name</label>
                                        <input class="form-control" id="first-name" name="name" type="text"
                                    ...
                                    <div class="col-lg-12">
                                        <label class="form-label" for="email3">Headline</label>
                                        <input class="form-control" id="email3" type="text"
                                            name=" headline"value="" required />
                                    </div>
                                    <div class="col-lg-12">
                                        <label class="form-label" for="email3">Position</label>
                                        <input class="form-control" id="email3" type="text"
                                            name="position"value="{{auth()->user()->types}}" required />
                                    </div>
                                    <div class="col-lg-12">
                                        <label class="form-label" for="email3">Country</label>
                                        <input class="form-control" id="email3" type="text"
                                            name=" country"value="" required />
                                    </div>
                                    <div class="col-lg-12">
                                        <label class="form-label" for="email3">Education</label>
                                        <input class="form-control" id="email3" type="text"
                                            name="education"value="" required />
                                    </div>

                                    <div class="col-lg-12">
                                        <label class="form-label" for="email3">Location</label>
                                        <input class="form-control" id="email3" type="text"
                                            name="location"value="" required />
                                    </div>

                                    <div class="col-lg-12">
                                        <label class="form-label" for="email3">college</label>
                                        <input class="form-control" id="email3" type="text"
                                            name="college"value="" required />
                                    </div>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body bg-light"><a class="mb-4 d-block d-flex align-items-center"
                                    ...
                                    aria-controls="experience-form1"><span class="circle-dashed"><span
                                            class="fas fa-plus"></span></span><span class="ms-3">Add new
                                        experience</span></a>
                                <div class="collapse" id="experience-form1">
                                    <form class="row">
                                        ...
                                        <div class="col-9 col-sm-7 mb-3">
                                            <input class="form-control form-control-sm" id="position"
                                                type="text" />
                                        </div>
                                        <div class="col-3 mb-3 text-lg-end">
                                        ...
                                        <div class="col-9 col-sm-7 offset-3 mb-3">
                                            <div class="form-check mb-0 lh-1">
                                                ...
                                                <label class="form-check-label mb-0" for="experience-current">I
                                                    currently work here
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-9 col-sm-7 mb-3">
                                            <input class="form-control form-control-sm text-500 datetimepicker"
                                                id="experience-form2" type="text" placeholder="d/m/y"
                                        ...
                                        <div class="col-9 col-sm-7 mb-3">
                                            <input class="form-control form-control-sm text-500 datetimepicker"
                                                id="experience-to" type="text" placeholder="d/m/y"
                                                data-options='{"dateFormat":"d/m/y","disableMobile":true}' />
                                        </div>
                            ...
                            <div class="card-body bg-light"><a class="mb-4 d-block d-flex align-items-center"
                                ...
                                <div class="collapse" id="education-form">
                                    <form class="row">
                                        ...
                                        <div class="col-9 col-sm-7 mb-3">
                                            <input class="form-control form-control-sm" id="school"
                                                type="text" />
                                        </div>
                                        <div class="col-3 mb-3 text-lg-end">
                                        ...
                                        <div class="col-9 col-sm-7 mb-3">
                                            <input class="form-control form-control-sm" id="degree"
                                                type="text" />
                                        </div>
                                        <div class="col-3 mb-3 text-lg-end">
                                        ...
                                        <div class="col-9 col-sm-7 mb-3">
                                            <input class="form-control form-control-sm" id="field"
                                                type="text" />
                                        </div>
                                        <div class="col-3 text-lg-end">
                                        ...
                                        <div class="col-9 col-sm-7 mb-3">
                                            <input class="form-control form-control-sm datetimepicker" id="edu-form3"
                                        ...
                                        <div class="col-9 col-sm-7 mb-3">
                                            <input class="form-control form-control-sm datetimepicker" id="edu-to"
                                                type="text" placeholder="d/m/y"
                                                data-options='{"dateFormat":"d/m/y"}' />
                                        </div>
                                        <div class="col-9 col-sm-7 offset-3">
                                ...
                                <div class="d-flex"><a href="#!"> <img class="img-fluid"
                                            ...
                                            width="56" /></a>
                                    <div class="flex-1 position-relative ps-3">
                                        <h6 class="fs-0 mb-0"> <a href="#!">Thomas Jefferson High School for
                                                Science and Technology<span data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="Verified"><small
                                                        class="fa fa-check-circle text-primary"
                                                        data-fa-transform="shrink-4 down-2"></small></span></a></h6>
                    ...
                    <div class="col-lg-4 ps-lg-2">
                        <div class="sticky-sidebar">
                            <div class="card mb-3 overflow-hidden">
                                ...
                                <div class="card-body bg-light">
                                    <h6 class="fw-bold">Who can see your profile ?<span
                                            class="fs--2 ms-1 text-primary" data-bs-toggle="tooltip"
                                    ...
                                    <div class="ps-2">
                                        <div class="form-check mb-0 lh-1">
                                            <input class="form-check-input" type="radio" value=""
                                                id="tag-everyone" name="tag-settings" />
                                            <label class="form-check-label mb-0" for="tag-everyone">Everyone
                                            </label>
                                        </div>
                                        <div class="form-check mb-0 lh-1">
                                            <input class="form-check-input" type="radio" value=""
                                                id="group-members" checked="checked" name="tag-settings" />
                                    ...
                                    <div class="border-dashed-bottom my-3"></div>
                                    <div class="form-check mb-0 lh-1">
                                        <input class="form-check-input" type="checkbox" id="userSettings1"
                                            checked="checked" />
                                        <label class="form-check-label mb-0" for="userSettings1">Allow users to show
                                            your followers
                                        </label>
                                    </div>
                                    <div class="form-check mb-0 lh-1">
                                        <input class="form-check-input" type="checkbox" id="userSettings2"
                                            checked="checked" />
                                        <label class="form-check-label mb-0" for="userSettings2">Allow users to show
                                            your email
                                        </label>
                                    </div>
                                    <div class="form-check mb-0 lh-1">
                                        <input class="form-check-input" type="checkbox" id="userSettings3" />
                                        <label class="form-check-label mb-0" for="userSettings3">Allow users to show
                                            your experiences
                                        </label>
                                    </div>
                                    <div class="border-dashed-bottom my-3"></div>
                                    <div class="form-check form-switch mb-0 lh-1">
                                        ...
                                        <label class="form-check-label mb-0" for="flexSwitchCheckDefault">Make your
                                    ...
                                    <div class="form-check form-switch mb-0 lh-1">
                                        ...
                                        <label class="form-check-label mb-0" for="flexSwitchCheckChecked">Allow user
                                            to follow you
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body bg-light border-top">
                                    <h5>Payment</h5>
                                    <p class="fs-0">You have not added any payment.</p><a
                                        class="btn btn-falcon-default btn-sm" href="#!">Add Payment </a>
                                </div>
                            </div>
                            <div class="card mb-3">
                                <div class="card-header">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body bg-light">
                                    ...
                                    <p class="fs--1">Transfer this account to another user or to an organization
                                        where you have the ability to create repositories.</p><a
                                        class="btn btn-falcon-warning d-block" href="#!">Transfer</a>
                                    <div class="border-dashed-bottom my-4"></div>
                                    <h5 class="fs-0">Delete this account</h5>
                                    <p class="fs--1">Once you delete a account, there is no going back. Please be
                                        certain.</p><a class="btn btn-falcon-danger d-block"
                ...
                <footer class="footer">
                    <div class="row g-0 justify-content-between fs--1 mt-4 mb-3">
                        <div class="col-12 col-sm-auto text-center">
                            <p class="mb-0 text-600">Thank you for creating with interviewo<span
    ...
    <div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1"
        ...
        <div class="offcanvas-body scrollbar-overlay px-card" id="themeController">
            ...
            <div class="text-center mt-5"><img class="mb-4"
                ...
                <p class="fs--1">Get interviewo now and create beautiful dashboards with hundreds of widgets.</p><a
