                      ...
                      <form class=" needs-validation" method="POST" action="/User_Login" novalidate>
                        ...
                        <div class="row gx-2">
                          ...
                          <div class="mb-3 col-sm-6">
                            ...
                            <select class="form-control" name="position" type="password" autocomplete="on" id="card-password" required>
                                <option value="student">Student</option>
                                <option value="insitiute">Institute</option>
                                <option value="employee">Employee</option>
                                <option value="enterprises">Enterprises</option>
                                <option value="startups">Statups</option>
                            </select>
                          </div
